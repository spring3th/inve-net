...
import one.inve.cluster.ClusterMath;
import one.inve.cluster.Member;
import one.inve.cluster.fdetector.FailureDetector;
import one.inve.cluster.fdetector.FailureDetectorEvent;
import one.inve.cluster.gossip.GossipProtocol;
import one.inve.cluster.membership.IdGenerator;
...
import static one.inve.cluster.membership.MemberStatus.ALIVE;
import static one.inve.cluster.membership.MemberStatus.DEAD;
