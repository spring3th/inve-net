package one.inve.cluster;

import static com.google.common.base.Preconditions.checkElementIndex;
import static com.google.common.base.Preconditions.checkNotNull;
import static one.inve.cluster.fdetector.FailureDetectorImpl.PING;
import static one.inve.cluster.fdetector.FailureDetectorImpl.PING_ACK;
import static one.inve.cluster.fdetector.FailureDetectorImpl.PING_REQ;
import static one.inve.cluster.gossip.GossipProtocolImpl.GOSSIP_REQ;
import static one.inve.cluster.membership.MembershipProtocolImpl.MEMBERSHIP_GOSSIP;
import static one.inve.cluster.membership.MembershipProtocolImpl.SYNC;
import static one.inve.cluster.membership.MembershipProtocolImpl.SYNC_ACK;

import one.inve.cluster.fdetector.FailureDetectorImpl;
import one.inve.cluster.gossip.GossipProtocolImpl;
import one.inve.cluster.membership.MembershipEvent;
import one.inve.cluster.membership.MembershipProtocolImpl;
import one.inve.transport.Address;
import one.inve.transport.Message;
import one.inve.transport.NetworkEmulator;
import one.inve.transport.Transport;
